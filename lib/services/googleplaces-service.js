...
function GooglePlacesService (apiKey) {
  ...
  this.getPlaceDetailsBy = function (placeid) {
    return rp(GoogleDetailApi + createQueryParameter("key", apiKey, true) + createQueryParameter("placeid", placeid))
    .then((resp) => JSON.parse(resp));
  }


  /**
   * [extractResultPlaceIds description]
